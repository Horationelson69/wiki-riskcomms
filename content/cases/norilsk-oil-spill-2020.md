...
| **Attribute**         | **Value** |
| --------------------- | --------- |
| **Organization**      | Nornickel (subsidiary fuel storage facility) |
| **Date**              | 2020-05-29 |
| **Crisis Type**       | Industrial environmental disaster (oil spill) |
| **Severity**          | Critical — largest oil spill in Arctic history (17,500 tonnes) |
...
| -------------- | ---------------- | ------------------ |
| [[golden-hour-response]] | Not applied — the company chose containment over disclosure during the critical early window | Failed |
...
- [Wikipedia — Norilsk oil spill](https://en.wikipedia.org/wiki/Norilsk_oil_spill)
- [Ken Institute — Norilsk Diesel Oil Spill: Russia's Worst Arctic Oil Spill](https://keninstitute.com/norilsk-diesel-oil-spill-russia-worlds-largst-arctic-oil-spill/)
- [Arctic WWF — Norilsk Nickel Must Be Held to Account](https://www.arcticwwf.org/newsroom/features/norilsk-nickel-must-be-held-to-account-for-devastating-fuel-spill/)
- [Nornickel — Sustainability Cleanup Projects](https://nornickel.com/sustainability/projects/cleanup/)
- [Uppsala University — Thesis Full Text](https://uu.diva-portal.org/smash/get/diva2:1795285/FULLTEXT01.pdf)
